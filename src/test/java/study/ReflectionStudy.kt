...
//        }
    ...
    @Test
    fun fieldAccessibilityTest() {
        // test java public static field
        var canAccess = TestClass_A::class.java.getDeclaredField("member1").canAccess(null)
        println("TestClass_A member1 can access: $canAccess")

        val a = TestClass_A()
        canAccess = a::class.java.getDeclaredField("member1").canAccess(null)
        //canAccess = a::class.java.getDeclaredField("member1").canAccess(a) // this will throws exception, can not pass non null object when check a static member
    }
